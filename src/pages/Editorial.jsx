...
import { Plus, ChevronLeft, ChevronRight, Upload, X, Link2, Trash2, Pencil, List, Calendar as CalendarIcon, Download, Loader2, FileVideo, Lightbulb, Repeat2, EyeOff } from "lucide-react";
        ...
        <DialogContent className="max-w-xl overflow-y-auto" style={{ maxHeight: '90vh' }}>
          ...
          {editData && (
            <div className="mt-1">
              ...
              {editData.workflow_type === "video" && (
                <EditorialVideoFields data={editData} setData={setEditData} clients={clients} videoEditors={videoEditors} readOnly={isReadOnly} />
              )}
