...
function CategoryFields({ category, meta = {}, onChange }) {
  ...
  const CATEGORIES_WITH_FIELDS = ["Design", "Video Editing", "Web", "Merch", "Analytics", "Administrative", "Posting"];
    ...
    fields = (
      <>
        ...
        <Field label="Content type">
          <MetaSelect value={meta.content_type} onChange={v => set("content_type", v)} placeholder="Post, Reel…">
        ...
        <Field label="Caption">
          <MetaSelect value={meta.caption} onChange={v => set("caption", v)} placeholder="Included?">
            <SelectItem value="yes">Included ✓</SelectItem>
            <SelectItem value="no">To write</SelectItem>
          </MetaSelect>
        </Field>
      </>
    );
    ...
    fields = (
      <>
        <Field label="Project type">
          <MetaSelect value={meta.web_type} onChange={v => set("web_type", v)} placeholder="Type">
            <SelectItem value="landing">Landing page</SelectItem>
            <SelectItem value="website">Full website</SelectItem>
            <SelectItem value="ecommerce">E-commerce</SelectItem>
            <SelectItem value="blog">Blog</SelectItem>
            <SelectItem value="dashboard">Dashboard</SelectItem>
            <SelectItem value="component">Component / feature</SelectItem>
          </MetaSelect>
        </Field>
        <Field label="Stack">
          <MetaSelect value={meta.stack} onChange={v => set("stack", v)} placeholder="React, WordPress…">
        ...
        <Field label="Pages / screens">
          <Input type="number" min={1} value={meta.pages || ""} onChange={e => set("pages", e.target.value)} placeholder="Ex: 5" className="h-9 bg-white" />
        </Field>
      </>
    );
  }
  ...
  if (category === "Merch") {
    fields = (
      <>
        <Field label="Product">
          <MetaSelect value={meta.product_type} onChange={v => set("product_type", v)} placeholder="T-shirt, Cap…">
        ...
        <Field label="Size">
          <MetaSelect value={meta.size} onChange={v => set("size", v)} placeholder="S, M, L…">
        ...
        <Field label="Quantity">
          <Input type="number" min={1} value={meta.quantity || ""} onChange={e => set("quantity", e.target.value)} placeholder="Ex: 50" className="h-9 bg-white" />
        </Field>
        <Field label="Color">
          <Input value={meta.color || ""} onChange={e => set("color", e.target.value)} placeholder="Ex: Black, White" className="h-9 bg-white" />
        </Field>
      </>
    );
  }
  ...
  if (category === "Analytics") {
    fields = (
      <>
        <Field label="Period">
          <MetaSelect value={meta.period} onChange={v => set("period", v)} placeholder="Monthly, Quarterly…">
        ...
        <Field label="Report type">
          <MetaSelect value={meta.report_type} onChange={v => set("report_type", v)} placeholder="Type">
    ...
    fields = (
      <>
        <Field label="Document type">
          <MetaSelect value={meta.doc_type} onChange={v => set("doc_type", v)} placeholder="Contract, Invoice…">
        ...
        <Field label="Signature required">
          <MetaSelect value={meta.signature} onChange={v => set("signature", v)} placeholder="Yes / No">
