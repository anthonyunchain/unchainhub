...
export default function NotesFAB({ userId, recentNotes = [] }) {
  ...
  return (
    <div ref={ref} style={{ position: "relative", flexShrink: 0 }}>
      {/* FAB button — matches NotificationBell exactly */}
      <button
        ...
        <div style={PANEL_STYLE}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              <button
                ...
                style={{
                  ...
                  background: creating ? "var(--brand)" : "var(--card-blue)",
                  color: creating ? "#fff" : "var(--brand)",
          ...
          {creating && (
            <div style={{ padding: "10px 12px", borderBottom: "1px solid var(--divider)", flexShrink: 0 }}>
              ...
              />
              {saveError && (
                <p style={{ fontSize: 10, color: "#ef4444", fontFamily: "'DM Mono', monospace", margin: "4px 0" }}>{saveError}</p>
              )}
              <button
                ...
                style={{
                  ...
                  fontFamily: "'Plus Jakarta Sans', sans-serif",
                  opacity: (createMut.isPending || !title.trim()) ? 0.6 : 1,
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 5,
                }}
              >
                {createMut.isPending
                  ? "Saving…"
                  : <><Check style={{ width: 12, height: 12 }} /> Save note</>
                }
              </button>
            </div>
          )}
                  ...
                  >
                    ...
                    {note.content && (
                      <p style={{
                        ...
                        fontSize: 10, color: "var(--muted)", margin: "2px 0 0",
          ...
          <div style={{ padding: "8px 12px", borderTop: "1px solid var(--divider)", flexShrink: 0 }}>
            <Link
              ...
              style={{
                ...
                fontFamily: "'DM Mono', monospace", fontSize: 10, color: "var(--brand)",
