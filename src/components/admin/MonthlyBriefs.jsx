  ...
  return (
    <div>
      ...
      <Dialog open={!!selectedBrief} onOpenChange={(o) => { if (!o) setSelected(null); }}>
        <DialogContent className="w-[92vw] sm:w-[50vw] sm:max-w-[50vw] p-0 overflow-hidden flex flex-col !bottom-auto !left-1/2 !right-auto !top-1/2 !-translate-x-1/2 !-translate-y-1/2 !rounded-2xl" style={{ aspectRatio: '16/9' }}>
