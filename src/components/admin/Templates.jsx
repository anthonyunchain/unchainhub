...
const STORAGE_KEY = "admin_templates_v1";
...
function loadTemplates() {
  ...
  return [
    { id: "1", name: "Proposal", description: "Client proposal template", type: "pdf", url: "" },
    { id: "2", name: "Client Contract", description: "Standard client contract", type: "pdf", url: "" },
    { id: "3", name: "Freelancer Contract", description: "Freelancer agreement template", type: "pdf", url: "" },
    { id: "4", name: "Unchain Studio Introduction", description: "Agency introduction deck", type: "pdf", url: "" },
    { id: "5", name: "Discovery Call", description: "Discovery call presentation", type: "slides", url: "" },
  ];
}
...
export default function Templates() {
  ...
  const openNew = () => {
    setEditData({ id: "", name: "", description: "", type: "pdf", url: "" });
    setDialogOpen(true);
  };
